...
class register(util.window):
	def __init__(self):
			...
			if not comm.link.testConnection():
				...
				if aok:
					...
					if data[0] == 'successful registration':
						...
						tkMessageBox.showerror("Registration Failed", "The username might be already taken. Do not use full stops or any other characters in entries ")


		# create window and its widgets
		util.window.__init__(self,"NGERIA MESS APP | Computerized Reservation System | REGISTRATION")
		...
		pick_secque = OptionMenu(register_frame,secque, "What was your favorite course in campus?", "Who is your COM 423 Supervisor?", "What is the name of your best friend", "What is your favorite meal?", "Which was your first school")
